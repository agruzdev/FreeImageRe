...
ExternalProject_Add(SVTAV1
    ...
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_ARG} "-DBUILD_SHARED_LIBS=OFF" "-DBUILD_APPS=OFF" "-DBUILD_TESTING=OFF" "-DSVT_AV1_LTO=ON" "-DUSE_CPUINFO=OFF" #"-DMINIMAL_BUILD=ON"
        ...
        "-DCMAKE_INSTALL_PREFIX:PATH=${EXTERNALPROJECT_BINARY_ROOT}/svtav1/install" ${CMAKE_DEBUG_POSTFIX_MULTICONF}
    EXCLUDE_FROM_ALL
)
...
set(SVTAV1_INCLUDE_DIRS ${EXTERNALPROJECT_BINARY_ROOT}/svtav1/install/include)
set(SVTAV1_LINK_DIRS ${EXTERNALPROJECT_BINARY_ROOT}/svtav1/install/lib)
