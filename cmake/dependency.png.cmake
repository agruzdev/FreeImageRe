...
ExternalProject_Add(PNG
    ...
    CMAKE_ARGS ${EXTERNALPROJECT_CMAKE_ARGS} "-DZLIB_USE_STATIC_LIBS:BOOL=ON" "-DZLIB_ROOT:PATH=${ZLIB_ROOT}" 
...
target_link_directories(LibPNG INTERFACE ${INSTALL_DIR}/lib)
if(MSVC)
    target_link_libraries(LibPNG INTERFACE libpng16_static.lib)
else()
    target_link_libraries(LibPNG INTERFACE png16)
endif()
