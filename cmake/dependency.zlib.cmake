...
if(WIN32)
    if (IS_DEBUG_CONFIG)
        set(ZLIB_LIBRARY ${ZLIB_ROOT}/lib/zsd${CMAKE_STATIC_LIBRARY_SUFFIX})
    else()
        set(ZLIB_LIBRARY ${ZLIB_ROOT}/lib/zs${CMAKE_STATIC_LIBRARY_SUFFIX})
    endif()
else()
    set(ZLIB_LIBRARY ${ZLIB_ROOT}/lib/libz${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
