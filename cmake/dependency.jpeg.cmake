...
if (JPEG_REPOSITORY STREQUAL "IJG")
    ...
    set(JPEG_INCLUDE_DIR ${JPEG_IJG_INCLUDE_DIR} CACHE INTERNAL "" FORCE)
    set(JPEG_LIBRARY_DIR ${JPEG_IJG_LIBRARY_DIR} CACHE INTERNAL "" FORCE)
    set(JPEG_LIBRARY ${JPEG_IJG_LIBRARY} CACHE INTERNAL "" FORCE)
...
elseif(JPEG_REPOSITORY STREQUAL "JPEG-turbo")
    ...
    set(JPEG_INCLUDE_DIR ${JPEG_TURBO_INCLUDE_DIR} CACHE INTERNAL "" FORCE)
    set(JPEG_LIBRARY_DIR ${JPEG_TURBO_LIBRARY_DIR} CACHE INTERNAL "" FORCE)
    set(JPEG_LIBRARY ${JPEG_TURBO_LIBRARY} CACHE INTERNAL "" FORCE)
else()
