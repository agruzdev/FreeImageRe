...
if (JPEG_REPOSITORY STREQUAL "IJG")
    ExternalProject_Add(JPEG
        ...
        CMAKE_ARGS ${CMAKE_TOOLCHAIN_FILE_ARG} ${CMAKE_BUILD_TYPE_ARG} ${EXTERNALPROJECT_CMAKE_ARGS} "-DCMAKE_INSTALL_PREFIX:PATH=${EXTERNALPROJECT_BINARY_ROOT}/jpeg/install"
        EXCLUDE_FROM_ALL
    )
...
elseif(JPEG_REPOSITORY STREQUAL "JPEG-turbo")
    ...
    ExternalProject_Add(TURBOJPEG
        ...
        CMAKE_ARGS ${CMAKE_TOOLCHAIN_FILE_ARG} ${CMAKE_BUILD_TYPE_ARG} ${EXTERNALPROJECT_CMAKE_ARGS} "-DENABLE_SHARED=OFF" "-DENABLE_STATIC=ON" "-DWITH_JPEG7=ON" "-DWITH_CRT_DLL=ON"
